...
public enum Instruction {
    ...
    JMP_ABSOLUTE_INDIRECT( 0x6C, AddressingMode.ABSOLUTE_INDIRECT, 3, 5, ExtraCycleCondition.NONE),
    ...
    TXA( 0x8A, AddressingMode.IMPLIED, 1, 2, ExtraCycleCondition.NONE),
    ...
    TYA( 0x98, AddressingMode.IMPLIED, 1, 2, ExtraCycleCondition.NONE),
    ...
    TAX( 0xAA, AddressingMode.IMPLIED, 1, 2, ExtraCycleCondition.NONE),
